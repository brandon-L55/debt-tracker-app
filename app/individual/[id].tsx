    ...
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        {person.phoneOrUsername ? (
          <Text style={styles.contact}>{person.phoneOrUsername}</Text>
        ) : null}
            ...
            <View key={debt.id} style={styles.txRow}>
              ...
              <View style={styles.txRight}>
                <Text
                  style={[
                    styles.txAmount,
                    debt.direction === "me" ? styles.amountRed : styles.amountGreen,
                  ]}
                >
...
const styles = StyleSheet.create({
  ...
  contact: { fontSize: 14, color: "#9CA3AF", marginTop: 2, marginBottom: 20 },
  cardRow: { flexDirection: "row", gap: 12, marginTop: 20, marginBottom: 28 },
